  ...
  return (
    <form onSubmit={handleSubmit} className={styled.form}>
      <div className={styled.dateFieldWrapper}>
        <label className={styled.label}>تاریخ</label>
        <input
          type="text"
          value={date}
      ...
      {errors.date && <span className={styled.errorText}>{errors.date}</span>}
      <div className={styled.amountFieldWrapper}>
        <label className={styled.label}>مبلغ (تومان)</label>
        <input
          type="text"
          value={amount}
      ...
      <div className={styled.transDesc}>
        <label className={styled.label}>شرح</label>
        <input
          type="text"
          value={description}
